...
export async function POST(req: Request) {
    try {
        ...
        const systemPrompt = [
            ...
            '2) 사용자가 챗봇의 기능이나 답변 가능한 범위를 물어보면, 구체적인 파일명을 나열하지 마세요. 대신 "지식산업센터와 산업단지 관련하여 답을 드릴 수 있으며, 특히 법률적인 부분(건축법, 세법 등)의 궁금증을 풀어드릴 수 있습니다."와 같이 전문가처럼 자연스럽게 대화체로 답변하세요.',
